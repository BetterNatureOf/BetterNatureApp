...
const styles = StyleSheet.create({
  ...
  summaryCard: { flex: 1, minWidth: 130, backgroundColor: Colors.white, borderRadius: Radius.xl, padding: 14, alignItems: 'center', borderWidth: 1, borderColor: Colors.glassBorder },
