...
window.CONTENT = {
  ...
  chapters: {
    ...
    featured: [
      { city: "Memphis", state: "TN", president: "Add name", members: 80 },
      { city: "Nashville", state: "TN", president: "Add name", members: 42 },
      { city: "Atlanta", state: "GA", president: "Add name", members: 56 },
      { city: "Austin", state: "TX", president: "Add name", members: 38 },
      { city: "Chicago", state: "IL", president: "Add name", members: 64 },
      { city: "Brooklyn", state: "NY", president: "Add name", members: 72 },
    ],
    totalCities: 38,
